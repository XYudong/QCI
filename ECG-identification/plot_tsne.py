...
method = 'comb'
print('loading data')
y_train, fea_train = load_data(dataset+'_'+method+'_fc1_class1_2_train.csv')
# print(fea_train.shape)
y_test, fea_test = load_data(dataset+'_'+method+'_fc1_class1_2_test.csv')
...
print('Xy training set: ', Xy_train.shape)

df_tr = pd.DataFrame(Xy_train)
df_te = pd.DataFrame(Xy_test)
df_tr.to_csv(dataset + '_' + method + '_2D_' + 'train.csv', header=None, index=None)
df_te.to_csv(dataset + '_' + method + '_2D_' + 'test.csv', header=None, index=None)
