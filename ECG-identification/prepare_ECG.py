...
def load_data():
    ...
    # print(type(labels))
    # idx = [i for (i, l) in enumerate(labels.tolist()) if l == 1 or l == 2]
    # data = np.array(data.iloc[idx, 0:])
...
# dump_data(train_batch, 'train_batch')


# xx = pd.read_csv('../data/ECG5000/ECG5000/ECG5000_class1_2_train.csv', header=None)
